...
function generateWord() {
  ...
  const wordArray = [
    "after", "again", "agree", "ahead", "aisle", "alien", "alive", "alone", "among", "anger",
    "apple", "argue", "arrow", "asset", "atlas", "audio", "avoid", "bacon", "badge", "baker",
    "bamboo", "beach", "beard", "beast", "began", "beige", "being", "below", "bench", "birth",
    "black", "blade", "blame", "blank", "bleach", "blend", "blessed", "block", "blood", "blouse",
    "boast", "bonus", "booth", "bored", "brain", "brass", "brave", "bread", "bride", "brief",
    "bring", "bronze", "broom", "brown", "brush", "built", "bully", "bunch", "bunny", "burst",
    "cabin", "cable", "cake", "camel", "candy", "canoe", "canvas", "canyon", "carbon", "carve",
    "catch", "cause", "cedar", "chair", "charm", "chase", "check", "cheese", "chest", "chick",
    "chief", "chili", "chime", "china", "cider", "cigar", "circus", "citrus", "civil", "claim",
    "clamp", "clean", "clear", "clerk", "click", "climb", "clip", "clock", "close", "cloth",
    "cloud", "clown", "coach", "coast", "cocoa", "coffee", "coin", "color", "comb", "comic",
    "common", "cool", "copper", "coral", "corner", "cost", "cotton", "couch", "cough", "count",
    "cover", "crack", "craft", "crash", "crate", "crawl", "crazy", "cream", "creek", "crew",
    "cricket", "crime", "crisp", "crop", "cross", "crowd", "crown", "crush", "cry", "crystal",
    "cube", "cup", "curve", "cute", "cycle", "dad", "dance", "danger", "dare", "dark", "dash",
    "date", "dawn", "dead", "deal", "death", "debate", "debt", "decay", "deck", "decor", "deep",
    "deer", "delay", "denim", "dense", "dent", "deny", "depth", "desert", "desk", "detail",
    "devil", "dial", "diamond", "diary", "dice", "diesel", "diet", "dig", "dilemma", "dine",
    "dinner", "dirt", "disco", "dish", "ditch", "diver", "divide", "dizzy", "doctor", "dodge",
    "doll", "dolphin", "dome", "donkey", "door", "dot", "double", "dove", "down", "dozen",
    "draft", "dragon", "drama", "draw", "dream", "dress", "drift", "drill", "drink", "drip",
    "drive", "drop", "drown", "drum", "dry", "duck", "dude", "due", "dull", "dummy", "dust",
    "duty", "dwarf", "eagle", "ear", "early", "earth", "ease", "east", "easy", "echo", "edge",
    "ego", "elbow", "elder", "elite", "else", "email", "emerge", "empty", "end", "energy",
    "enjoy", "enough", "enter", "entry", "envy", "epic", "equal", "erase", "error", "escape",
    "essay", "estate", "even", "event", "evil", "exact", "example", "exit", "expand", "expert",
    "explore", "express", "extend", "extra", "eye", "fabric", "face", "fade", "faint", "faith",
    "fake", "fame", "family", "fan", "fancy", "fantasy", "farm", "fashion", "fast", "fatal",
    "father", "fatigue", "faucet", "fault", "favor", "feather", "feature", "federal", "fee",
    "feed", "feel", "fellow", "female", "fence", "festival", "fever", "few", "fiber", "fiction",
    "field", "fierce", "fight", "figure", "file", "film", "filter", "final", "find", "fine",
    "finger", "finish", "fire", "firm", "first", "fish", "fit", "five", "fix", "flag", "flame",
    "flap", "flash", "flat", "flavor", "flee", "fleet", "flesh", "flight", "flip", "float",
    "flock", "floor", "flourish", "flow", "flower", "fluid", "flush", "fly", "foam", "focus",
    "fog", "foil", "fold", "follow", "fond", "food", "fool", "foot", "force", "forest", "forget",
    "fork", "formal", "fortune", "forum", "fossil", "foster", "foul", "fox", "fragment", "frame",
    "frantic", "free", "fresh", "friend", "fringe", "frog", "front", "frost", "fruit", "fuel",
    "fulfill", "full", "fun", "funny", "furious", "future", "gain", "galaxy", "game", "gap",
    "garage", "garden", "garlic", "gas", "gate", "gather", "gear", "gender", "general", "genius",
    "gentle", "genuine", "gesture", "ghost", "giant", "gift", "ginger", "girl", "give", "glad",
    "glance", "glare", "glass", "glide", "global", "glory", "glove", "glow", "glue", "goat",
    "goddess", "gold", "good", "gorgeous", "gospel", "gossip", "govern", "gown", "grab", "grace",
    "grade", "grain", "grand", "grape", "grass", "grave", "great", "green", "greet", "grid",
    "grief", "grill", "grip", "groove", "gross", "ground", "group", "grow", "grunt", "guard",
    "guess", "guest", "guide", "guilt", "guitar", "gun", "guru", "habit", "hack", "hair", "half",
    "hammer", "hand", "handsome", "happy", "harbor", "hard", "harmony", "harvest", "hat", "hatch",
    "hate", "have", "hawk", "hazard", "head", "health", "heart", "heat", "heavy", "hedge",
    "height", "hell", "hello", "help", "hen", "here", "hero", "hidden", "high", "hike", "hill",
    "hint", "hip", "hire", "history", "hit", "hive", "hobby", "hold", "holiday", "hollow", "holy",
    "home", "honey", "honor", "hope", "horn", "horror", "horse", "hospital", "host", "hotel",
    "hour", "hover", "hub", "huge", "human", "humor", "hundred", "hungry", "hunt", "hurdle",
    "hurry", "hurt", "husband", "hybrid", "ice", "icon", "idea", "identify", "idle", "ignore",
    "ill", "illegal", "image", "immense", "immune", "impact", "import", "improve", "impulse",
    "inch", "include", "income", "increase", "index", "indicate", "individual", "indoor",
    "industry", "infant", "inform", "inherit", "initial", "inject", "injury", "innocent", "input",
    "inquiry", "insane", "insect", "inside", "inspire", "instant", "intact", "intense", "interest",
    "into", "invest", "invite", "involve", "iron", "island", "isolate", "issue", "item", "ivory",
    "jacket", "jail", "jam", "jazz", "jealous", "jeans", "jelly", "jet", "jewel", "job", "join",
    "joke", "journey", "joy", "judge", "juice", "jump", "jungle", "junior", "junk", "jury",
    "just", "justice", "keen", "keep", "kettle", "key", "kick", "kid", "kidney", "kill", "kind",
    "king", "kiss", "kit", "kitchen", "kite", "kitten", "knit", "knock", "know", "label", "labor",
    "ladder", "lady", "lake", "lamb", "lamp", "language", "large", "last", "late", "laugh",
    "launch", "law", "lawn", "lawsuit", "lawyer", "layer", "lazy", "lead", "leaf", "leak", "learn",
    "lease", "leave", "lecture", "left", "leg", "legal", "lemon", "lend", "length", "lens",
    "leopard", "lesson", "let", "letter", "level", "liar", "liberty", "library", "license", "life",
    "lift", "light", "like", "limb", "limit", "link", "lion", "liquid", "list", "listen", "little",
    "live", "lizard", "load", "loan", "lobby", "lobster", "local", "lock", "logic", "lonely",
    "long", "look", "loop", "loose", "lord", "loud", "love", "loyal", "luck", "luggage", "lumber",
    "lunch", "luxury", "lyric", "machine", "mad", "magic", "magnet", "maid", "mail", "main",
    "major", "make", "mammal", "man", "manage", "mandate", "mango", "mansion", "manual", "map",
    "marble", "march", "margin", "marine", "market", "marry", "mask", "mass", "master", "match",
    ...
    "might", "mild", "milk", "million", "mimic", "mind", "mineral", "minimum", "minor", "minute",
    "miracle", "mirror", "misery", "miss", "mistake", "mix", "mixed", "mobile", "model", "modify",
    "mom", "moment", "monitor", "monkey", "monster", "month", "moon", "moral", "morning",
    "mosquito", "mother", "motion", "motor", "mountain", "mouse", "move", "movie", "much", "muffin",
    "mule", "multiply", "muscle", "museum", "mushroom", "music", "must", "mutant", "mystery",
    "myth", "nail", "name", "nap", "napkin", "narrow", "nasty", "nation", "nature", "near", "neck",
    "need", "negative", "neglect", "neither", "nephew", "nerve", "nest", "net", "network", "neutral",
    "never", "new", "news", "next", "nice", "night", "noble", "noise", "none", "noodle", "normal",
    ...
    "ocean", "octopus", "odor", "off", "offer", "office", "often", "oil", "okay", "old", "olive",
    "olympic", "omit", "once", "one", "onion", "online", "only", "open", "opera", "opinion",
    "oppose", "option", "orange", "orbit", "orchard", "order", "ordinary", "organ", "orient",
    "original", "orphan", "ostrich", "other", "outdoor", "outer", "output", "outside", "oval",
    "oven", "over", "own", "owner", "oxygen", "oyster", "ozone", "pact", "paddle", "page", "pair",
    ...
    "pipe", "pistol", "pitch", "pizza", "place", "planet", "plastic", "plate", "play", "pleasant",
    "pledge", "plot", "plow", "plunge", "poem", "poet", "point", "polar", "pole", "police", "pond",
    "pony", "pool", "popular", "portion", "position", "possible", "post", "potato", "potential",
    "pouch", "pound", "powder", "power", "practice", "praise", "predict", "prefer", "prepare",
    ...
    "quit", "quiz", "quote", "rabbit", "race", "rack", "radar", "radio", "rail", "rain", "raise",
    ...
    "roast", "robot", "robust", "rock", "rocket", "romance", "roof", "rookie", "room", "rose",
    ...
    "settle", "setup", "seven", "shadow", "shaft", "shallow", "shame", "share", "shed", "shell",
    "sheriff", "shield", "shift", "shine", "ship", "shiver", "shock", "shoe", "shoot", "shop",
    "short", "shoulder", "shove", "shrimp", "shrug", "shuffle", "shy", "sibling", "sick", "side",
    "siege", "sight", "sign", "silent", "silk", "silly", "silver", "similar", "simple", "since",
    "sing", "siren", "sister", "sit", "six", "size", "skate", "sketch", "ski", "skill", "skin",
    ...
    "toe", "together", "toilet", "token", "tomato", "tomorrow", "tone", "tongue", "tonight",
